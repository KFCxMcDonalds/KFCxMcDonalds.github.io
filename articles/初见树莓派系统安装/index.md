...
<img src="/images/初见树莓派：系统安装/Imager下载页面.png" />

现在官方提供了系统镜像的安装软件(以前只有镜像文件)，系统安装更简单了，点击下载。完成后打开：

<img src="/images/初见树莓派：系统安装/Imager.png" />

点击选择操作系统，可以看到提供了多个选项：

<img src="/images/初见树莓派：系统安装/OS.png" />
...
{{< admonition type=note >}}如果红灯常量且黄灯规律地两次闪烁，可能是电源电压不足，树莓派需要5V3A的电源，如果电源功率不足，树莓派不能正常运行，这是本人遇到过的问题。{{< /admonition >}}
